...
from owl_vit.big_vision import bit
from owl_vit.big_vision import vit
import flax
...
from owl_vit import utils
from owl_vit.clip import layers as clip_layers
...
class BoxMaskHead(nn.Module):
  ...
  def load(
      self, params: Params, init_config: ConfigDict
  ) -> Params:
    """Loads backbone parameters for this model from a checkpoint."""
    params = params.copy()
