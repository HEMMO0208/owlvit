...
from owl_vit.big_vision import registry as pp_registry
import einops
import flax
...
def tree_get(tree, name):
  ...
  try:
    ...
    msg = ConfigDict(flattened)._generate_did_you_mean_message(name, msg)  # pylint: disable=protected-access
