...
from owl_vit import layers
from owl_vit import matching_base_models
import owl_vit.utils.utils as utils
from owl_vit.clip import model as clip_model
from owl_vit.clip import tokenizer as clip_tokenizer
...
class TextZeroShotDetectionModule(nn.Module):
  ...
  body_configs: ConfigDict
  objectness_head_configs: Optional[ConfigDict] = None
  mask_head_configs: Optional[ConfigDict] = None
