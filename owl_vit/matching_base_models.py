...
from owl_vit import matchers
from owl_vit.utils import base_model
from owl_vit.utils import box_utils
from owl_vit.utils import model_utils
from owl_vit import losses as losses_lib
...
class BaseModelWithMatching(base_model.BaseModel, metaclass=abc.ABCMeta):
  ...
  def __init__(self, config: Optional[ConfigDict],
